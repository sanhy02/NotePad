...
public class JNotepad extends JFrame {
    ...
    private JMenuItem itemNew, itemOpen, itemSave, itemSaveAs, itemPageSetup, itemPrint, itemExit, itemFont, itemUndo, itemCut, itemCopy,
            itemPaste, itemDelete, itemSearchwithBing, itemFind, itemFindNext, itemReplace, itemGoTo, itemSelectAll, itemTimeDate,
            itemZoomIn, itemZoomOut, itemRestoreDefaultZoom, itemViewHelp, itemAboutNotepad;
...
//        processEvent();
    ...
    txtEditor.setLineWrap(itemWordWrap.isSelected());
    txtEditor.setWrapStyleWord(itemWordWrap.isSelected()); // Ngắt dòng theo từ
}
